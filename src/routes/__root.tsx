...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Her sabah BIST 100 teknik analiz paylaşımları ve eğitim içerikleri Telegram analiz topluluğunda." },
      ...
      { name: "twitter:description", content: "Her sabah BIST 100 teknik analiz paylaşımları ve eğitim içerikleri Telegram analiz topluluğunda." },
